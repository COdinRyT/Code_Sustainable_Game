...
public class TutorialManager : MonoBehaviour
{
    ...
    void Start()
    {
        tutorialDetails = new string[]
        {
            ...
            "The market has two set things in the shop you can acquire when you click on it, with a menu system at the bottom that opens ups. \r\n\r\nNote the small circle button in the corner. The x symbol is to close out of the shop when you are finished with it, the screen will open back up if you click on the shop menu button. ",
